...
Borderline::Borderline(float x, float y, color_t color) {
    ...
    static const GLfloat vertex_buffer_data[] = {
        ...
        100.0f, 0.05f, 0.1f,
        -100.0f, 0.05f, 0.1f,
        100.0f,-0.05f, 0.1f// 12
    };

    this->object = create3DObject(GL_TRIANGLES, 12*3, vertex_buffer_data, color, GL_FILL);
}

void Borderline::draw(glm::mat4 VP) {
...
void Borderline::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Borderline::tick() {
    //this->rotation += speed;
