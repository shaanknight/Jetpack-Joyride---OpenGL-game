...
Convexellipse::Convexellipse(float x_pos, float y_pos, float r, color_t color) {
...
void Convexellipse::draw(glm::mat4 VP) {
...
void Convexellipse::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Convexellipse::tick(int fl) {
    if(fl == 1)
    {
